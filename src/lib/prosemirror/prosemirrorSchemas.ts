...
const pDOM: Array<any> = ['p', 0];
const blockquoteDOM: Array<any> = ['blockquote', 0];
const brDOM: Array<any> = ['br'];
const olDOM: Array<any> = ['ol', 0];
const ulDOM: Array<any> = ['ul', 0];
const liDOM: Array<any> = ['li', 0];
const emDOM: Array<any> = ['em', 0];
const strongDOM: Array<any> = ['strong', 0];
